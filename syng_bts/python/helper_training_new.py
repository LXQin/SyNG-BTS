    ...
    if modelname == "CVAE":
        ...
        if early_stop:
            ...
            if save_new:
                ...
                plot_new_samples(model = model, savepathnew = None, latent_size = 32, modelname = "VAE", num_images = new_size, plot = plot, colnames = colnames, col_max = col_max, col_sd = col_sd)
                plt.show()
        ...
        log_dict, best_model = ht.train_AE(num_epochs = num_epochs,
                                        ...
                                        logging_interval = 50,
                                        save_model = save_model)
        plot_training_loss(log_dict['val_loss_per_batch'], num_epochs, custom_label = " loss")
        plt.show()
